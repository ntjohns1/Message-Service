...
public class MsgServiceTest {
    ...
    public void getAll() {
        ...
        Flux<Msg> saved = repository.saveAll(Flux.just(new Msg(null, "Josh", "Hello", time), new Msg(null, "Matt", "Hello", time), new Msg(null, "Jane", "Hello", time)));
    ...
    @Test
    public void save() {
        Mono<Msg> msgMono = this.service.create("Buddy", "Hello");
    ...
    public void delete() {
        String test = "test";
        Mono<Msg> deleted = this.service.create(test, test).flatMap(saved -> this.service.delete(saved.getId()));
    ...
    public void getById() {
        final String time = new SimpleDateFormat("dd-MM-yy HH:mm").format(new Date());
        repository.save(new Msg("1", "Jane", "Hello", time));
